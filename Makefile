ajax:
	grep -rl admin-ajax.php . | xargs sed -i '' -e 's/https:\/\/adm.ganhoaocubo.com\/wp-admin\/admin-ajax.php/https:\/\/adm.ganhoaocubo.comhttps:\/\/adm.ganhoaocubo.com\/wp-admin\/admin-ajax.php/g'
